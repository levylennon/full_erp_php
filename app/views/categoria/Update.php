            ...
            <div class="col-12">
                <div class="caixa">
                    <div class="caixa-titulo py-1 d-inline-block width-100">
                        <span class="h5 mb-0 d-inline-block"><i class="fas fa-pen-square"></i> Atualizar categoria</span>
                    ...
                    <form action="<?php echo URL_BASE ."categoria/Inserir" ?>" method="Post">
                        <div class="col-6 d-block m-auto rows px-5 mt-5">
                            ...
                            <div class="col-12 mt-3 mb-5">
                                ...
                                <input type="submit" name="" value="Atualizar categoria"  class="btn btn-azul d-block m-auto">
                            </div>
                        </div>
                    </form>
                </div>
