<nav class="menuprincipal">					
    <ul class="menu-ul">
        <li><a href="<?php echo URL_BASE ?>"><i class="fa fa-fw fa-home"></i> Inicio</a></li>
		<div class="modulos">	
			<div class="item">
        ...
        <div class="modulos">	
			<div class="item">
		<li class="cat"><a href=""><i class="fas fa-cash-register"></i> Vendas</a></li>
			<div>				 
       ...
       <div class="modulos">	
		<div class="item">	
			<li class="cat"><a href=""><i class="fas fa-file-invoice-dollar"></i> NFE</a></li>
            <div>
		...
		<div class="modulos">	
			<div class="item">
			<li class="cat"><a href=""><i class="far fa-fw fa-file"></i> PEDIDOS</a></li>
				<div>
       ...
       <div class="modulos">	
		<div class="item">		
            <li class="cat"><a href=""><i class="fas fa-box-open"></i> ESTOQUE</a></li>
			<div>
       ...
       <div class="modulos">	
		<div class="item">	
            <li class="cat"><a href=""><i class="fas fa-hand-holding-usd"></i> FINANCEIRO</a></li>            
            <div>
       ...
       <div class="modulos">	
		<div class="item">
            <li class="cat"><a href=""><i class="fas fa-users"></i> PESSOAL</a></li> 
       ...
       <div class="modulos">	
			<div class="item">	
				<li class="cat"><a href=""><i class="fas fa-file-invoice-dollar"></i> CONTÁBIL/FISCAL</a></li>            
					<div>
       ...
       <div class="modulos">	
			<div class="item">	
				<li class="cat"><a href=""><i class="fas fa-tools"></i> PRODUÇÃO</a></li>
